...
$('.home-category-wrapper .category-title').click(function(e) {
    e.stopPropagation();
    if ($(window).width() <= 767) {
        $('.home-category-wrapper .sidebar-main-nav-wrapper').toggleClass('visible');
    }
});

$('.home-category-wrapper .sidebar-main-nav-wrapper').click(function(e) {
    e.stopPropagation();
});

$(document).click(function(e) {
    $('.home-category-wrapper .sidebar-main-nav-wrapper').removeClass('visible');
});
// $(window).on('load', function() {
//     if ($(window).width() <= 450) {
...
$(document).ready(function(e) {
    ...
    $(".header-center-sidebar-main-nav-wrapper").click(function(e) {
        e.stopPropagation();
    });
    $(document).on("click", function(e) {
        $(".header-center-sidebar-main-nav-wrapper").removeClass("show");
    });
});
...
let noimage = "{{ asset('avatar/'.$customer->avatar) }}";
