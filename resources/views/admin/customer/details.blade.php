                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="input-group-wrap">
                                        ...
                                        <input type="text" name="store" class="form-control" value="Binnomart" readonly>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="input-group-wrap">
                                ...
                                <div class="col-md-12" id="ZoneWrapper">
                                    <div class="input-group-wrap">
                                        ...
                                        <select name="zone" id="zone" class="form-control">
                                            ...
                                            {{-- <input type="text" name="zone_name" id="zone_name" value="{{$order->pathao_zone_name}}"> --}}
                                            @endif
                                        </select>
                                    </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="mt-3 mb-3">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <input class="form-control" type="number" name="area" id="area" value="{{ $area = $order->area }}">
                                    </div>
                                </div>
                            </div>
                            <div class="mt-3 mb-3">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        @if($order->discount != null && $order->advance == null)
                                            <input class="form-control total_price" type="text" name="total_price" id="total_price" value="{{ ($sum + $area) - $order->discount }}">
                                        @endif
                                        ...
                                        @if($order->discount != null && $order->advance != null)
                                            ...
                                            @endphp
                                            <input class="form-control total_price" type="text" name="total_price" id="total_price" value="{{ $z }}">
                                        @endif

                                        @if($order->advance == null && $order->discount == null)
                                            <input class="form-control total_price" type="text" name="total_price" id="total_price" value="{{ ($sum + $area) }}">
                                        @endif
