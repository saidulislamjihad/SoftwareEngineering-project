                ...
                <div class="col-md-12 col-sm-12">
                    <div id="app">
                        <div class="container container-space">
                            <div class="row">
                                <div class="col-md-5">
                                    <img v-show="!thumnailImage" :src = "details.image" alt = "shoe image" class="product-details-main-img">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <h3 class="details-product-price">
                                        Price: ৳
                                        <span v-if="details.discount_price != null">
                                            <b style="margin-left: 10px;">{{details.discount_price}}</b>
                                            <del>
                                    ...
                                    <div class = "purchase-info outer" v-else>
                                        <div class="purchase-info-inner">
                                            <div class="product-quantity">
                                                <input type="text" min="1" max="10" class="quantity" v-model="qty" id="qty" placeholder="Qty">
                                            </div>
                                        ...
                                        <div class="buy-now-btn-innner">
                                            <button type = "button" class ="btn buy-now" @click="buyNow(details)">
