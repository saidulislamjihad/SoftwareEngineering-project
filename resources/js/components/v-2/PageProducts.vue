<template>
    <div id="app">
        <div class="row" v-if="products.length > 0">
            <div class="col-lg-2 col-md-4 col-sm-6" v-for="product in products" :key="product.id">
...
<!--&lt;!&ndash;                            <a class="action-btn" href="#">&ndash;&gt;-->
<!--&lt;!&ndash;                                <i class="far fa-heart"></i>&ndash;&gt;-->
<!--&lt;!&ndash;                            </a>&ndash;&gt;-->
...
import axios from "axios"
   ...
   export default {
       ...
       methods: {
           getPageProducts(){
               axios.get('/api/page-products/' + this.pageName)
                .then(response => {
