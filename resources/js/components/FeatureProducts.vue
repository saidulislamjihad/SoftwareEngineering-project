<template>
    <div id="app">
                ...
                <div class="section-title">
                    <h2 class="title">
                        ...
                        <div class="title-bottom-animarion">
                            <img :src="'frontend/assets/logo/Trustshoper-Icon.png'" alt="">
                        </div>
                    </h2>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-lg-3 col-md-4 col-sm-6" v-for="product in featureProducts" :key="product.id">
...
<!--                            </div>-->
        ...
        <div class="load-more-btn">
            <button class="load-more" style="cursor: pointer; border-outline: none;" :disabled="!next_page_url" @click.prevent="loadMore(next_page_url)">Load more</button>
        </div>
<!--        <div class="row">-->
