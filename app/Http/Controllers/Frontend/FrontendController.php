...
class FrontendController extends Controller
{
    public function index()
    {
        ...
        $hot_products = Product::where('product_type', 'hot')->where('status', 1)->get();
        $new_products = Product::where('product_type', 'new')->where('status', 1)->get();
        $regular_products = Product::where('product_type', 'feature')->where('status', 1)->get();
        $discount_products = Product::where('product_type', 'discount')->where('status', 1)->get();
    ...
    public function shops()
    {
        ...
        $products = Product::select(['id', 'slug', 'name', 'regular_price', 'discount_price', 'image'])->get();
        return view('frontend.v-2.product.shop-products', compact('categories', 'products'));
    }
